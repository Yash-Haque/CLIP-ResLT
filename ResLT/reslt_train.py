...
def main(args):
    ...
    # dataset = hrb.HERB(cfg)
    # dm = DataManager(cfg, dataset)
    print_args(args, cfg)
...
if __name__ == "__main__":
    ...
    # parser.add_argument("--dataset-metadata", type=str, default="", help="path to train/test metadata")
